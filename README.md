José silva tem uma rotina, muito comum, ele tem um pequeno negócio de vendas de projetos, é um projeto modelo que pode ser facilmente adaptado para gerir prefeituras no processo de licitações.
