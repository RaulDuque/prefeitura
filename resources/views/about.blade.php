<x-app-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        ...
        Começou a contatar as prefeituras e oferecer o seu projeto.') }}<br>
        {{ __( 'E viu que o sistema em planilha ficou um pouco complicado.') }}<br>
        {{ __( 'Resolveu nos procurar para fazer um pequeno sistema que consiga facilmente gerir seu negócio.') }}<br>
        {{ __('Ele quer registrar as prefeituras, com nome, cidade, telefone, números de habitantes, nome do prefeito e ponto focal (Pessoa que conversa diretamente).
        ...
        Ao final, ele deve classificar a prefeitura como ganha ou perda.') }}<br>
        {{ __(' A ganha é que o projeto foi vendido, a perda foi que deixou claro que não tem interesse (pelo menos na gestão do atual Prefeito).
